// variant.cpp for cazzette_xiao_nrf52840_plus
...
const uint32_t g_ADigitalPinMap[] =
{
    ...
    28, // D2  is P0.28 (A2)
    29, // D3  is P0.29 (A3)
     0, // D4 << UNUSED >>>      // D4  is P0.04 (A4,SDA)
     0, // D5 << UNUSED >>>      // D5  is P0.05 (A5,SCL)
     0, // D6 << UNUSED >>>      // D6  is P1.11 (TX)
     0, // D7 << UNUSED >>>      // D7  is P1.12 (RX)
     4, // D8  is P0.04 (A4,SDA) // D4  is P0.04 (A4,SDA)
     5, // D9  is P0.05 (A5,SCL) // D5  is P0.05 (A5,SCL)
    43, // D10 is P1.11 (TX)     // D6  is P1.11 (TX)
    44, // D11 is P1.12 (RX)     // D7  is P1.12 (RX)
    45, // D12 is P1.13 (SCK)    // D8  is P1.13 (SCK)
    46, // D13 is P1.14 (MISO)   // D9  is P1.14 (MISO)
    47, // D14 is P1.15 (MOSI)   // D10 is P1.15 (MOSI)

/*
    // (moved to the bottom)     // LEDs
